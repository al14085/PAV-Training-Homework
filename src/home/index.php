  ...
  <body>
	  ...
	  <header> 
		...
		<div id="form">
			...
			<form id="login" method="post" action="/login">
				<input type="text" name="username" placeholder="User name" <?php if(isset($_SESSION['LOGGED_IN']) && isset($_SESSION['USERNAME'])){ ?>value=<?php echo $_SESSION['USERNAME']; }?> />
				<input type="password" name="password" placeholder="Password"/>
				<label><input type="checkbox" name="rememberUsername" />Remember me </label>
	  ...
	  <div id="main">
			<div id="main-content">
				...
				<h3 style='color:red;'>You are not logged in!!! please login to view more info</h3>	
			</div>
			<div id="sidebar">
				<h3> Sidebar </h3>
				<ul>
